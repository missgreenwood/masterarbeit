...
barplot(compl2, ylab="Anzahl Vergleiche", main="Komplexität der k-nächste-Nachbarn-Suche", col=c("dodgerblue3", "darkolivegreen3"), beside=TRUE, ylim=c(0,1000), xaxt="n")
