...
% -------------------------------------------------------------------------------------------------
%
\lmutitle{Organisation von Bloom-Filtern \\zur effizienten k-nächste-Nachbarn-Suche \\in einem kontextzentrischen sozialen Netz}                       % title: you can force a new line by
...
%
    ...
    \input{text/hintergrund}
    \input{text/implementierung}
    \input{text/evaluation}
    \input{text/schlussbemerkungen}
%
% =================================================================================================
