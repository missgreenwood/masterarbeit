...
% -------------------------------------------------------------------------------------------------
%
\lmutitle{Organisation von Bloom-Filtern \\zur effizienten \textit{k}-nächste-Nachbarn-Suche \\in kontextzentrischen sozialen Netzen}                       % title: you can force a new line by
